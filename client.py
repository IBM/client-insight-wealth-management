...
# Query String parameters; pageSize, page, score_code, effective_date, model_scope_forecast_horizon
def retrieve_client_attrition_score(customer_id):
    ...
    while True:
        scores_url = "customers/" + str(customer_id) + "/scores?page_size=" + str(page_size) + "&page=" + str(page) + "&score_code=ATTRITION&effective_date=2017-12-31&model_scope_forecast_horizon=6"
